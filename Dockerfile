...
RUN wget  https://repo1.maven.org/maven2/com/datastax/spark/spark-cassandra-connector_2.12/3.0.0/spark-cassandra-connector_2.12-3.0.0.jar
RUN wget https://repo1.maven.org/maven2/com/datastax/oss/java-driver-core/4.12.1/java-driver-core-4.12.1.jar
RUN wget https://repo1.maven.org/maven2/com/datastax/spark/spark-cassandra-connector-driver_2.12/3.0.0/spark-cassandra-connector-driver_2.12-3.0.0.jar
